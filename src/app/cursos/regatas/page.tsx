...
const SERVICO = SERVICOS.find((s) => s.slug === "regatas")!;
...
export default function CursoRegatasPage() {
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          <p className="text-lg leading-relaxed text-cinza-escuro">
            Treinamento específico para velejadores que querem competir.
            Técnicas de regata, tática e estratégia. Detalhes em breve — fale
            com a gente pelo WhatsApp pra saber mais.
          </p>
