...
const SERVICO = SERVICOS.find((s) => s.slug === "passeios")!;
...
export default function CursoPasseiosPage() {
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          <p className="text-lg leading-relaxed text-cinza-escuro">
            Passeios de veleiro pela Baía de Vitória. Experiência
            inesquecível pra você, sua família ou amigos. Detalhes, roteiros e
            valores em breve — fale com a gente pelo WhatsApp e a gente monta
            um programa sob medida.
          </p>
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a
              href={whatsappLink(
                `Oi, Marlon! Gostaria de saber mais sobre os ${SERVICO.name}.`
              )}
              target="_blank"
