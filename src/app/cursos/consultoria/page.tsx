...
const SERVICO = SERVICOS.find((s) => s.slug === "consultoria")!;
...
export default function CursoConsultoriaPage() {
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          <p className="text-lg leading-relaxed text-cinza-escuro">
            Consultoria personalizada pra quem quer orientação profissional —
            seja pra escolher embarcação, planejar uma viagem, melhorar
            performance, ou tirar um projeto náutico do papel. Atendimento
            individualizado, focado no seu objetivo.
          </p>
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a
              href={whatsappLink(
                `Oi, Marlon! Gostaria de saber mais sobre ${SERVICO.name}.`
              )}
              target="_blank"
