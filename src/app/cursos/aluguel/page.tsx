...
const SERVICO = SERVICOS.find((s) => s.slug === "aluguel")!;
...
export default function CursoAluguelPage() {
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          <p className="text-lg leading-relaxed text-cinza-escuro">
            Já tem experiência com vela? Alugue um dos nossos veleiros e
            aproveite a liberdade de curtir a baía de Vitória no seu ritmo.
            Modalidades por hora, diária ou fim de semana. Fale com a gente
            pelo WhatsApp pra ver disponibilidade e valores.
          </p>
